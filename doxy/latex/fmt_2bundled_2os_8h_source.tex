\doxysection{os.\+h}
\hypertarget{fmt_2bundled_2os_8h_source}{}\label{fmt_2bundled_2os_8h_source}\index{C:/Users/osann/source/repos/OSANNnn/Delirium-\/Engine/Delirium/vendor/spdlog/include/spdlog/fmt/bundled/os.h@{C:/Users/osann/source/repos/OSANNnn/Delirium-\/Engine/Delirium/vendor/spdlog/include/spdlog/fmt/bundled/os.h}}
...
\DoxyCodeLine{00117\ \mbox{\hyperlink{base_8h_a9a4960b70582ed2620911a0b75dce0b5}{FMT\_API}}\ \textcolor{keywordtype}{void}\ format\_windows\_error(buffer<char>\&\ out,\ \textcolor{keywordtype}{int}\ error\_code,}
\DoxyCodeLine{00118\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ message)\ \textcolor{keyword}{noexcept};}
\DoxyCodeLine{00119\ \}}
\DoxyCodeLine{00120\ }
\DoxyCodeLine{00121\ \mbox{\hyperlink{base_8h_a9a4960b70582ed2620911a0b75dce0b5}{FMT\_API}}\ std::system\_error\ vwindows\_error(\textcolor{keywordtype}{int}\ error\_code,\ \mbox{\hyperlink{base_8h_a204ca715c2febee035464fa53dfc50c4}{string\_view}}\ format\_str,}
\DoxyCodeLine{00122\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{base_8h_abd8c737296655b44480da4fb422add24}{format\_args}}\ args);}
\DoxyCodeLine{00123\ }
\DoxyCodeLine{00149\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}...\ Args>}
\DoxyCodeLine{00150\ std::system\_error\ windows\_error(\textcolor{keywordtype}{int}\ error\_code,\ \mbox{\hyperlink{base_8h_a204ca715c2febee035464fa53dfc50c4}{string\_view}}\ message,}
...
\DoxyCodeLine{00166\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ S,\ \textcolor{keyword}{typename}...\ Args,\ \textcolor{keyword}{typename}\ Char\ =\ \mbox{\hyperlink{base_8h_a6345d871b0af4ac3a2682038d7a53625}{char\_t<S>}}>}
\DoxyCodeLine{00167\ \textcolor{keywordtype}{void}\ say(\textcolor{keyword}{const}\ S\&\ format\_str,\ Args\&\&...\ args)\ \{}
\DoxyCodeLine{00168\ \ \ std::system(\mbox{\hyperlink{color_8h_a12b134d4f21276bc7e0473bd2cdb1c9c}{format}}(\textcolor{stringliteral}{"{}say\ \(\backslash\)"{}\{\}\(\backslash\)"{}"{}},\ \mbox{\hyperlink{color_8h_a12b134d4f21276bc7e0473bd2cdb1c9c}{format}}(format\_str,\ args...)).c\_str());}
\DoxyCodeLine{00169\ \}}
...
\DoxyCodeLine{00178\ }
\DoxyCodeLine{00179\ \ \ \textcolor{keyword}{explicit}\ \mbox{\hyperlink{classbuffered__file_a8059859b738bd114d3be4dca5412613a}{buffered\_file}}(FILE*\ f)\ :\ file\_(f)\ \{\}}
\DoxyCodeLine{00180\ }
...
\DoxyCodeLine{00186\ \ \ \mbox{\hyperlink{classbuffered__file_a8059859b738bd114d3be4dca5412613a}{buffered\_file}}()\ noexcept\ :\ file\_(\textcolor{keywordtype}{nullptr})\ \{\}}
\DoxyCodeLine{00187\ }
...
\DoxyCodeLine{00194\ \ \ \}}
\DoxyCodeLine{00195\ }
\DoxyCodeLine{00196\ \ \ \textcolor{keyword}{auto}\ \mbox{\hyperlink{classbuffered__file_a33308b4c0abd9052c384d4628dd7da72}{operator=}}(buffered\_file\&\&\ other)\ -\/>\ buffered\_file\&\ \{}
...
\DoxyCodeLine{00210\ \ \ \textcolor{keyword}{auto}\ \mbox{\hyperlink{classbuffered__file_a7671996f5a3f5333d1f3ab8b8eeb03b6}{get}}()\ const\ noexcept\ -\/>\ FILE*\ \{\ \textcolor{keywordflow}{return}\ file\_;\ \}}
\DoxyCodeLine{00211\ }
...
\DoxyCodeLine{00217\ \ \ \ \ \mbox{\hyperlink{namespacedetail_a0dc7ed966c3ead3db768720aa1491ed3}{detail::is\_locking}}<T...>()\ ?\ fmt::vprint\_buffered(file\_,\ \mbox{\hyperlink{namespacefmt}{fmt}},\ vargs)}
\DoxyCodeLine{00218\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ :\ fmt::vprint(file\_,\ \mbox{\hyperlink{namespacefmt}{fmt}},\ vargs);}
\DoxyCodeLine{00219\ \ \ \}}
\DoxyCodeLine{00220\ \};}
\DoxyCodeLine{00221\ }
...
\DoxyCodeLine{00247\ \ \ \ \ TRUNC\ =\ \mbox{\hyperlink{fmt_2bundled_2os_8h_a6fa0773ef89920062fe6ab8b6e3cf337}{FMT\_POSIX}}(O\_TRUNC)\ \ \ \ \ \textcolor{comment}{//\ Truncate\ the\ content\ of\ the\ file.}}
\DoxyCodeLine{00248\ \ \ \};}
\DoxyCodeLine{00249\ }
...
\DoxyCodeLine{00364\ }
\DoxyCodeLine{00365\ \ \ \mbox{\hyperlink{base_8h_a9a4960b70582ed2620911a0b75dce0b5}{FMT\_API}}\ \textcolor{keyword}{static}\ \textcolor{keywordtype}{void}\ grow(buffer<char>\&\ buf,\ \textcolor{keywordtype}{size\_t});}
\DoxyCodeLine{00366\ }
\DoxyCodeLine{00367\ \ \textcolor{keyword}{public}:}
\DoxyCodeLine{00368\ \ \ \mbox{\hyperlink{base_8h_a9a4960b70582ed2620911a0b75dce0b5}{FMT\_API}}\ file\_buffer(\mbox{\hyperlink{fmt_2bundled_2os_8h_ab5093e382f19cf769bbb8fed27dd7b1f}{cstring\_view}}\ path,\ \textcolor{keyword}{const}\ ostream\_params\&\ params);}
\DoxyCodeLine{00369\ \ \ \mbox{\hyperlink{base_8h_a9a4960b70582ed2620911a0b75dce0b5}{FMT\_API}}\ file\_buffer(file\_buffer\&\&\ other)\ \textcolor{keyword}{noexcept};}
\DoxyCodeLine{00370\ \ \ \mbox{\hyperlink{base_8h_a9a4960b70582ed2620911a0b75dce0b5}{FMT\_API}}\ \string~file\_buffer();}
\DoxyCodeLine{00371\ }
\DoxyCodeLine{00372\ \ \ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{namespacespdlog_1_1details_a22274995cf879a5d0a08d1f7513ee4fba86f354b8575a1a736775ae003fa344e5}{flush}}()\ \{}
\DoxyCodeLine{00373\ \ \ \ \ \textcolor{keywordflow}{if}\ (size()\ ==\ 0)\ \textcolor{keywordflow}{return};}
\DoxyCodeLine{00374\ \ \ \ \ file\_.write(\mbox{\hyperlink{namespaceextract__version_a814f8396ecd14daca6006f27cadb467c}{data}}(),\ size()\ *\ \textcolor{keyword}{sizeof}(\mbox{\hyperlink{namespaceextract__version_a814f8396ecd14daca6006f27cadb467c}{data}}()[0]));}
\DoxyCodeLine{00375\ \ \ \ \ clear();}
\DoxyCodeLine{00376\ \ \ \}}
\DoxyCodeLine{00377\ }
\DoxyCodeLine{00378\ \ \ \textcolor{keywordtype}{void}\ close()\ \{}
\DoxyCodeLine{00379\ \ \ \ \ \mbox{\hyperlink{namespacespdlog_1_1details_a22274995cf879a5d0a08d1f7513ee4fba86f354b8575a1a736775ae003fa344e5}{flush}}();}
...
\DoxyCodeLine{00387\ }
\DoxyCodeLine{00390\ \textcolor{keyword}{class\ }\mbox{\hyperlink{base_8h_a9a4960b70582ed2620911a0b75dce0b5}{FMT\_API}}\ ostream\ \{}
\DoxyCodeLine{00391\ \ \textcolor{keyword}{private}:}
\DoxyCodeLine{00392\ \ \ \mbox{\hyperlink{base_8h_ac9487321d6c482c5f5550eb04b2bbf1e}{FMT\_MSC\_WARNING}}(suppress\ :\ 4251)}
\DoxyCodeLine{00393\ \ \ detail::file\_buffer\ buffer\_;}
\DoxyCodeLine{00394\ }
\DoxyCodeLine{00395\ \ \ ostream(\mbox{\hyperlink{fmt_2bundled_2os_8h_ab5093e382f19cf769bbb8fed27dd7b1f}{cstring\_view}}\ path,\ \textcolor{keyword}{const}\ detail::ostream\_params\&\ params)}
...
\DoxyCodeLine{00402\ }
\DoxyCodeLine{00403\ \ \ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{namespacespdlog_1_1details_a22274995cf879a5d0a08d1f7513ee4fba86f354b8575a1a736775ae003fa344e5}{flush}}()\ \{\ buffer\_.flush();\ \}}
\DoxyCodeLine{00404\ }
\DoxyCodeLine{00405\ \ \ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}...\ T>}
\DoxyCodeLine{00406\ \ \ \textcolor{keyword}{friend}\ \textcolor{keyword}{auto}\ output\_file(\mbox{\hyperlink{fmt_2bundled_2os_8h_ab5093e382f19cf769bbb8fed27dd7b1f}{cstring\_view}}\ path,\ T...\ params)\ -\/>\ ostream;}
\DoxyCodeLine{00407\ }
\DoxyCodeLine{00408\ \ \ \textcolor{keywordtype}{void}\ close()\ \{\ buffer\_.close();\ \}}
\DoxyCodeLine{00409\ }
\DoxyCodeLine{00412\ \ \ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}...\ T>\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{base_8h_a59025bfaf390e425b4e274c966a77557}{print}}(\mbox{\hyperlink{base_8h_a56a828fb91283babdb0eef8e0d9010cb}{format\_string<T...>}}\ fmt,\ T\&\&...\ args)\ \{}
\DoxyCodeLine{00413\ \ \ \ \ \mbox{\hyperlink{base_8h_a3683dd5284154b2cc412c5623a3a850c}{vformat\_to}}(\mbox{\hyperlink{base_8h_a6572319cff9106ebe28538bf10641524}{appender}}(buffer\_),\ fmt,\ fmt::make\_format\_args(args...));}
\DoxyCodeLine{00414\ \ \ \}}
\DoxyCodeLine{00415\ \};}
\DoxyCodeLine{00416\ }
\DoxyCodeLine{00430\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}...\ T>}
\DoxyCodeLine{00431\ \textcolor{keyword}{inline}\ \textcolor{keyword}{auto}\ output\_file(\mbox{\hyperlink{fmt_2bundled_2os_8h_ab5093e382f19cf769bbb8fed27dd7b1f}{cstring\_view}}\ path,\ T...\ params)\ -\/>\ ostream\ \{}
...
\DoxyCodeLine{00435\ }
\DoxyCodeLine{00436\ \mbox{\hyperlink{base_8h_a06c2cd8d4ba997d81bcb06c0cdb47410}{FMT\_END\_EXPORT}}}
\DoxyCodeLine{00437\ \mbox{\hyperlink{base_8h_ae0d2fbdf031547a949fc7e1c0b3c97f1}{FMT\_END\_NAMESPACE}}}
\DoxyCodeLine{00438\ }
